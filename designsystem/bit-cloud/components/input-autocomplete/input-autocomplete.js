...
export const InputAutocomplete = forwardRef(
  (
    ...
    const formatFreeTextInputToSuggestion = (query) => ({
    ...
    return (
      <div ref={autocompleteRef} css={[containerStyle]}>
        <div css={inputAndSubmitWrapper}>
          <div css={inputAndDropdownWrapper}>
            <label css={[labelStyle]} htmlFor={autoCompleteInputId}>
              {placeholder}
            </label>
            <input
              role="combobox"
              ...
              css={[
                ...
                showingResult && !useHeaderSearchStyle
                  ? inputHasSuggestionsStyle
                  : null,
                showingResult && useHeaderSearchStyle
                  ? inputHeaderSearchHasSuggestionsStyle
            ...
            >
              {suggestions.map((suggestion, index) => (
                <li
                  css={[
                    dropdownItemStyle,
                    index === activeIndex ? dropdownItemActiveStyle : null,
                  ]}
                  key={index}
                  role="option"
          ...
          {searchButton && (
            ...
            >
              <span css={[searchButtonTextStyle]}>{searchButtonText}</span>

              <SystemIcon aria-hidden="true" icon="MonoSearch" />
            </button>
          )}
        </div>
      </div>
