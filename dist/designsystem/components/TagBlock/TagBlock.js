...
var _LinkArrow = _interopRequireDefault(
  require('../Icons/SystemIcons/LinkArrow/LinkArrow')
);

var _Arrow = _interopRequireDefault(
  require('../Icons/SystemIcons/Arrow/Arrow')
);
...
var TagBlock = _react['default'].forwardRef(function (_ref, ref) {
  ...
  return (0, _core.jsx)(
    ...
    {
      css: [
        _TagBlock.tagBlockItem,
        invertedColors ? _TagBlock.invertedTag : null,
        style,
      ],
    },
    (0, _core.jsx)(
      ...
      (0, _core.jsx)(
        SelectedHeading,
        {
          ...
          css: [
            _TagBlock.tagHeading,
            icon != null ? _TagBlock.tagIconHeading : null,
          ],
        },
        heading
      ),
      secondaryArrowStyle
        ? (0, _core.jsx)(_LinkArrow['default'], {
            'aria-hidden': 'true',
