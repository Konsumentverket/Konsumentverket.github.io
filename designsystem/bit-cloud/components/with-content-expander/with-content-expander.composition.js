          ...
          wrappedComponent={
            <div>
              ...
              <p>
                ...
                vulputate risus sit amet lorem volutpat, eu aliquam odio varius.
                Morbi arcu magna, suscipit finibus tortor ac, vehicula malesuada
                urna. Quisque non aliquam enim. In dictum, sapien vel rhoncus
                elementum.
              </p>
              <p>
                Aliquam sit amet sapien eget velit tempus posuere. Vivamus
                facilisis nulla rhoncus orci dictum, eu molestie ipsum varius.
                Duis egestas turpis sed turpis aliquet, at consequat sem mollis.
                Nunc mollis, tellus in sodales dictum, erat diam volutpat lacus,
                sed mattis est libero eget ex.
              </p>
              <WithContentExpander
                ...
                wrappedComponent={
                  <div>
                    ...
                    <p>
                      Suspendisse rhoncus sem quis feugiat facilisis.
                      Pellentesque vulputate risus sit amet lorem volutpat
                    </p>
                    <div className={'noStyleComponent'}>
                      <h2>
                        This h2 should not be styled since it's not a direct
                        child in the first div in the Typography component
                      </h2>
          ...
          <div>
            <ul className="kov-1k4kh7i-fancyDots-Markdown">
              <li>
                <p>
                  <a
                    href="/miljo-och-hallbarhet/miljomedvetna-matval/"
                    rel=""
                    className=" kov-1d260cr-linkStyle"
                  >
              ...
              <li>
                <p>
                  <a
                    href="https://www2.jordbruksverket.se/webdav/files/SJV/trycksaker/Pdf_rapporter/ra09_20.pdf"
                    rel=""
                    className=" external kov-1d260cr-linkStyle"
                  >
                    På Jordbruksverkets webbplats kan du läsa rapporten ”Vad får
                    du som konsument när du köper närproducerat”
                    <svg
                      className="external kov-1ojobql-External"
                      width="18"
                      height="19"
                      fill="none"
                      viewBox="0 0 18 19"
              ...
              <li>
                <p>
                  <a
                    href="http://smakasverige.se/"
                    rel=""
                    className=" external kov-1d260cr-linkStyle"
                  >
                    Läs om regional mat och skyddade ursprungs- och geografiska
                    beteckningar på webbplatsen Smaka Sverige
                    <svg
                      className="external kov-1ojobql-External"
                      width="18"
                      height="19"
            ...
            <WithContentExpander
              ...
              wrappedComponent={
                <div>
                  ...
                  <div className={'noStyleComponent'}>
                    <h2>
                      This h2 should not be styled since it's not a direct child
                      in the first div in the Typography component
                    </h2>
                    <p>Neither this paragraph</p>
                  </div>
                </div>
...
export const BasicWithSubComponentWithContentExpander = () => {
  return (
    <CompositionFonts>
      <GlobalStyles />
      <p>
        Suspendisse rhoncus sem quis feugiat facilisis. Pellentesque vulputate
        risus sit amet lorem volutpat, eu aliquam odio varius. Morbi arcu magna,
        suscipit finibus tortor ac, vehicula malesuada urna. Quisque non aliquam
        enim. In dictum, sapien vel rhoncus elementum.
      </p>
      <p>
        Suspendisse rhoncus sem quis feugiat facilisis. Pellentesque vulputate
        risus sit amet lorem volutpat, eu aliquam odio varius. Morbi arcu magna,
