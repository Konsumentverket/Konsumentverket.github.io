...
const fileIcon = (fileSvgPath) => `
  &:before{
    background-image: url("data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 22 30' %3E%3Cpath fill='${encodeURIComponent(
      colors.theme1.mid
    )}' d='${fileSvgPath}'/%3E%3C/svg%3E");
  }
`;
