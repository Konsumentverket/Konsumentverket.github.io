...
export const Craftsman = ({ className, style, title, ...otherAttr }) => {
  return (
    <svg
      className={className}
      css={[iconStyle, style]}
