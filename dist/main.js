...
var core = require('@emotion/react');
...
var fileIcon = function fileIcon(fileSvgPath) {
  return "\n  &:before{\n    background-image: url(\"data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 22 30' %3E%3Cpath fill='"
    .concat(encodeURIComponent(colors.theme1.mid), "' d='")
    .concat(fileSvgPath, '\'/%3E%3C/svg%3E");\n  }\n');
};

var globalStyles = function globalStyles() {
  var fontSize =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '62.5%';
  var fontFamily =
  ...
  return core.css(
    ...
    colors.theme1.mid,
    colors.theme1.mid,
    colors.theme1.midLight,
    fileIcon(filePdfPath),
    fileIcon(filePowerpointPath),
    fileIcon(fileWordPath),
    fileIcon(fileExcelPath),
    fileIcon(filePath),
    colors.theme1.midLight,
    colors.theme1.midLight,
    colors.theme1.mid,
    colors.states.visited,
    colors.states.visited,
    colors.theme1.midLight,
    colors.theme1.midLight,
    colors.theme1.xDark,
...
var LinkColorsInverted = core.css(
  _templateObject3(),
  colors.theme1.mid,
  colors.theme1.xDark,
  colors.states.visited
...
var LinkWrapperInvertedColorStyle = core.css(
  _templateObject5(),
  LinkColorsInverted
);
var ElementLinkColorStyle = core.css(_templateObject6(), LinkColors);
var ElementLinkInvertedColorStyle = core.css(
  _templateObject7(),
  LinkColorsInverted
);
...
var Ecc = function (_ref) {
  ...
  return core.jsx(
    ...
    core.jsx('polygon', {
      points:
        '22.5779013 30.784614 24.8519345 30.784614 24.8519345 31.3384601 23.4364648 31.3384601 23.4364648 32.9769217 24.6895035 32.9769217 24.6895035 33.5538448 23.4364648 33.5538448 23.4364648 35.307691 24.8519345 35.307691 24.8519345 35.8846141 22.5779013 35.8846141',
    }),
    core.jsx('path', {
    ...
    core.jsx('polygon', {
      points:
        '40.6309399 31.5 41.4198902 31.5 41.4198902 32.4692308 41.8607742 32.4692308 41.8607742 32.9538462 41.4198902 32.9538462 41.4198902 35.8846154 40.6309399 35.8846154 40.6309399 32.9538462 40.2132604 32.9538462 40.2132604 32.4692308 40.6309399 32.4692308',
    }),
    core.jsx('path', {
        ...
        core.jsx(
          ...
          core.jsx(
            ...
            core.jsx(
              ...
              {
                transform:
                  'translate(21.000000, 20.500000) scale(-1, 1) translate(-21.000000, -20.500000) translate(18.000000, 10.000000)',
              },
              core.jsx('path', {
...
var Icon = function Icon(_ref) {
  var icon = _ref.icon,
    ...
    style = _ref.style,
    title = _ref.title,
    otherAttr = _objectWithoutProperties(_ref, [
      'icon',
      'className',
      'style',
      'title',
  ...
  if (Element === undefined) {
    console.log(
      'Could not find icon in storybook tried to load: '.concat(icon)
    );
    return null;
  }
    ...
    core.jsx(
      ...
      core.jsx(
        ...
        core.jsx(
          ...
          {
            transform:
              'translate(272.500000, 1111.000000) scale(-1, 1) translate(-272.500000, -1111.000000) translate(261.000000, 1095.000000)',
          },
          core.jsx('path', {
...
var LinkColorsInverted$1 = core.css(
  _templateObject3$1(),
  colors.theme1.mid,
  colors.theme1.xDark,
  colors.states.visited
...
var LinkWrapperInvertedColorStyle$1 = core.css(
  _templateObject5$1(),
  LinkColorsInverted$1
);
var ElementLinkColorStyle$1 = core.css(_templateObject6$1(), LinkColors$1);
var ElementLinkInvertedColorStyle$1 = core.css(
  _templateObject7$1(),
  LinkColorsInverted$1
);
...
var tagLink = core.css(
  _templateObject3$4(),
  colors.theme1.mid,
  colors.theme1.midDark,
  colors.theme1.xDark,
  colors.theme1.xDark
);
    ...
    tags.slice(0, 3).map(function (child, idx) {
      return core.jsx(
        ...
        core.jsx(Tag, {
          ...
          url: child.url,
          text:
            (child.titleInNavigation && child.titleInNavigation) ||
            (child.title && child.title) ||
            (child.headline && child.headline),
          style: tagItem,
        })
      );
    })
...
var TagBlock = React__default.forwardRef(function (_ref, ref) {
  var _ref$invertedColors = _ref.invertedColors,
    invertedColors =
      _ref$invertedColors === void 0 ? false : _ref$invertedColors,
    ...
    secondaryArrowStyle =
      _ref$secondaryArrowSt === void 0 ? false : _ref$secondaryArrowSt;
  var headings = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'h7'];
...
var wrapper$1 = core.css(
  _templateObject$8(),
  colors.theme3.xLight,
  spacing.m,
  spacing.s,
  spacing.m,
  spacing.s,
...
var FactBox = function FactBox(_ref) {
  ...
  return core.jsx(
    'div',
    {
      css: [
        wrapper$1,
        LinkWrapperInvertedColorStyle$1,
...
var linkTextCardContentStyle = core.css(
  _templateObject9$3(),
  colors.theme3.dark
);
...
var LinkCard = React__default.forwardRef(function (_ref, ref) {
  var text = _ref.text,
    ...
    beforeToggleCount =
      _ref$beforeToggleCoun === void 0 ? 3 : _ref$beforeToggleCoun,
    style = _ref.style,
...
var disabledStyle = core.css(
  _templateObject4$8(),
  colors.theme3.mid,
  colors.theme3.midLight,
  colors.theme3.light,
  colors.theme3.mid
);
...
var disabled = core.css(
  _templateObject$d(),
  colors.theme3.mid,
  colors.theme3.midLight,
  colors.theme3.mid
);
var buttonStyle = core.css(
  _templateObject2$c(),
  colors.common.white,
  colors.buttons.primary.backgroundColor,
  colors.common.white,
  medium,
  colors.buttons.primary.hover,
  colors.buttons.primary.active,
  disabled
);
var secondaryStyle = core.css(
  _templateObject3$b(),
  colors.buttons.secondary.textColor,
  colors.buttons.secondary.borderColor,
  colors.buttons.secondary.textColor,
  colors.buttons.secondary.hover,
  colors.theme1.xDark,
  colors.common.white,
  colors.buttons.secondary.active,
  colors.common.white,
  disabled
);
var invertedBackgroundStyle = core.css(
  _templateObject4$a(),
  colors.common.white,
  colors.theme1.dark
);
var invertedSecondaryBackgroundStyle = core.css(
  _templateObject5$9(),
  colors.common.white,
  colors.common.white,
  colors.common.white,
...
var Button = function Button(_ref) {
  var text = _ref.text,
    ...
    secondaryButtonStyle =
      _ref$secondaryButtonS === void 0 ? false : _ref$secondaryButtonS,
    _ref$invertedBackgrou = _ref.invertedBackgroundColor,
    invertedBackgroundColor =
      _ref$invertedBackgrou === void 0 ? false : _ref$invertedBackgrou,
    className = _ref.className,
    id = _ref.id,
    _ref$type = _ref.type,
  ...
  invertedBackgroundColor &&
    secondaryButtonStyle &&
    styles.push(invertedSecondaryBackgroundStyle);
  ...
  return href
    ? core.jsx('a', props, iconLeft, text, iconRight)
    : core.jsx('button', props, iconLeft, text, iconRight);
};
...
var searchFieldInputStyle = core.css(
  _templateObject4$b(),
  colors.common.white,
  spacing.xs,
  spacing.xs,
...
var FormSearchField = React__default.forwardRef(function (_ref, _ref2) {
  ...
  invertedBackgroundColor &&
    searchFieldInputStyles.push(invertedBackgroundStyle$1);
  var inputRef = React.useRef();
  var ariaAttrs = {};
  Object.keys(other)
    .filter(function (x) {
...
function _templateObject3$e() {
  var data = _taggedTemplateLiteral([
    ...
    ';\n    background-color: ',
    ";\n    text-decoration: underline;\n  }\n\n  .checkbox:checked + .checkbox-label:before {\n    animation: fadein .2s ease-out;\n    background-image: url(\"data:image/svg+xml;charset=utf8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 85 85' %3E%3Cpath fill='",
    "' d='",
...
var invertedfieldStyle = core.css(
  _templateObject5$b(),
  colors.common.white,
  colors.theme1.xDark,
  colors.common.white
...
var invertedfieldStyle$1 = core.css(
  _templateObject5$c(),
  colors.common.white,
  colors.theme1.xDark,
  colors.common.white
...
var wrapper$3 = function wrapper(success) {
  return css(
    _templateObject$i(),
    success ? colors.common.success : colors.common.warning,
    success ? colors.common.success : colors.common.warning
  );
};
...
var ValidationResponse = function ValidationResponse(_ref) {
  ...
  return core.jsx(
    ...
    success ? core.jsx(Check, null) : core.jsx(Clear, null),
    text,
    children
  );
};
...
function _templateObject$j() {
  var data = _taggedTemplateLiteral([
    '\n    appearance: none;\n    width: 100%;\n    padding: 1.2rem 1.6rem;\n    box-sizing:border-box;\n    border: 2px solid ',
    ";\n    border-radius: 0.8rem;\n    -khtml-border-radius: 0.8rem; /* this is for the fruit phones */\n    font-size: 1.8rem;\n    line-height: 3rem;\n    background-image: url(\"data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20'><path fill='",
    "' d='",
...
var selectStyle = core.css(
  _templateObject$j(),
  colors.theme3.midLight,
  encodeURIComponent(colors.theme1.mid),
  arrowPath,
  colors.theme3.dark
);
...
var disabled$2 = core.css(
  _templateObject$k(),
  colors.theme3.mid,
  colors.theme3.midLight,
  colors.theme3.mid
);
var expandButtonStyle = core.css(
  _templateObject2$i(),
  colors.common.white,
  colors.theme1.mid,
  colors.common.white,
...
var invertedBackgroundStyle$2 = core.css(
  _templateObject5$d(),
  colors.common.white,
  colors.theme1.dark
);
var invertedSecondaryBackgroundStyle$1 = core.css(
  _templateObject6$b(),
  colors.common.white,
  colors.common.white,
  colors.common.white,
...
var linkShowAllWrapper = core.css(
  _templateObject5$g(),
  spacing.s,
  medium,
  spacing.l
...
var isVisibleLetter = function isVisibleLetter(visibleLetters, letter) {
  return (
    ...
    visibleLetters.some(function (v) {
      return v === letter;
    })
  );
};
...
var DisplayAlphabet = function DisplayAlphabet(_ref) {
  var onClickLetter = _ref.onClickLetter,
    ...
    displayShowAllLink =
      _ref$displayShowAllLi === void 0 ? true : _ref$displayShowAllLi;
  return core.jsx(
    React__default.Fragment,
    null,
    core.jsx(
      ...
      alphabet.map(function (letter$1) {
        return isVisibleLetter(visibleLetters, letter$1)
          ? core.jsx(
              'a',
              {
                key: letter$1,
                css: [
                  letter,
                  letter$1 === activeLetter$1 ? activeLetter : null,
                ],
    ...
    core.jsx(
      ...
      sourcesCollection &&
        ...
        core.jsx(
          'p',
          null,
          sourceText ? ''.concat(sourceText, ' ') : 'Källa: ',
          sourcesCollection.items.map(function (item, idx) {
            return core.jsx(
              'a',
              {
                href: item.linkUrl,
                key: 'link-' + idx,
                css: sourceLink,
                className: isExternal(baseUrl, item.linkUrl)
                  ? 'external'
                  : null,
              },
              item.linkText,
      ...
      reviewed &&
        core.jsx(
          ...
          core.jsx(
            ...
            ''
              .concat(
                reviewedDateText || english ? 'Proofread: ' : 'Granskad: '
              )
              .concat(reviewed.getDate(), ' ')
              .concat(
                english
              ...
              .concat(reviewed.getFullYear())
          )
        )
    ),
    bottomContent && core.jsx('div', null, bottomContent)
  );
};
...
var backgroundSize = function backgroundSize(rows) {
  return new Array(rows).fill(0).map(function () {
    return ''
      .concat(randomIntFromInterval(80, 90), '% ')
      .concat(spacing.m, ',');
  });
};
...
var distanceIndicatorStyle = core.css(
  _templateObject6$g(),
  colors.theme1.mid,
  medium
);
var currentPageStyle = core.css(
  _templateObject7$d(),
  colors.theme1.dark,
  colors.theme1.mid
);
...
var Pagination = function Pagination(_ref) {
  ...
  var links = Object.keys(
    _toConsumableArray(new Array(totalNumberOfPages))
  ).map(function (val) {
    return parseInt(val) + 1;
  });
  var searchRadius =
    currentPage == totalNumberOfPages || currentPage == 1 ? 2 : 1;
  ...
  return core.jsx(
    ...
    firstLink(),
    filteredLink.map(function (pageNumber) {
...
var grayContentExpanderWrapper = core.css(
  _templateObject$r(),
  colors.theme3.xLight,
  colors.states.focus,
  colors.theme1.mid
);
var grayFocusedOnExpansionWrapper = core.css(
  _templateObject2$o(),
  colors.theme3.light,
  spacing.xs,
  colors.theme3.xLight,
...
var ComponentWrapperStyle = core.css(
  _templateObject3$n(),
  small,
  colors.theme1.mid
);
...
var collapseButtonStyle = core.css(
  _templateObject7$e(),
  spacing.xs,
  colors.theme1.mid,
  colors.theme1.mid,
...
var WithContentExpander = function WithContentExpander(_ref) {
  var wrappedComponent = _ref.wrappedComponent,
    ...
    hasCollapseButton =
      _ref$hasCollapseButto === void 0 ? false : _ref$hasCollapseButto,
    _ref$show = _ref.show,
    show = _ref$show === void 0 ? true : _ref$show,
    _ref$scrollIntoView = _ref.scrollIntoView,
    scrollIntoView =
      _ref$scrollIntoView === void 0 ? false : _ref$scrollIntoView,
    wrapperStyle = _ref.wrapperStyle,
    _ref$open = _ref.open,
  ...
  return core.jsx(
    'div',
    {
      className: 'withContentExpander '
        .concat(isFullWidth ? 'full-width' : null, ' ')
        .concat(expanded ? 'expanded' : null),
      id: wrapperId,
