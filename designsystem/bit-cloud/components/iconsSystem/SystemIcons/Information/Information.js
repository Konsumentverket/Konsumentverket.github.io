...
const iconStyle = css`
  path:first-of-type {
    ...
    stroke: ${newColors.shades.fullBlue};
  }
...
export const Information = ({ className, style, title, ...otherAttr }) => {
  return (
    <svg
      className={className}
      css={[iconStyle, style]}
