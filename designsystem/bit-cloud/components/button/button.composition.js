...
export const BasicButton = () => {
  ...
  return (
    <>
      <CompositionFonts>
        <GlobalStyles />
        <div style={whiteBackground}>{element}</div>
        <div style={blackBackground}>{element}</div>
      </CompositionFonts>
    </>
  );
};
...
export const BasicIconRightButton = () => {
  const element = (
    <Button
      href={'#'}
      iconRight={<Icon icon="MonoDownload" />}
      text="Lorem ipsum"
    />
  );
...
// No style button with icon example
export const NoLinkStyleButton = () => {
  const element = (
    <Button
      href={'/test'}
      text="Lorem ipsum"
...
export const BasicLinkButton = () => {
  const element = <Button text="Lorem ipsum" href="#" />;
...
export const BasicSecondaryBasicButton = () => {
  const element = <Button text="Lorem ipsum" secondaryButtonStyle={true} />;
