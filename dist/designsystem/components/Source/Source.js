...
var _External = _interopRequireDefault(
  require('../Icons/SystemIcons/External/External')
);
...
var Source = function Source(_ref) {
  ...
  return (0, _core.jsx)(
          ...
          sourcesCollection.items.map(function (item, idx) {
            return (0, _core.jsx)(
              'a',
              {
                ...
                className: (0, _isExternalUrl['default'])(baseUrl, item.linkUrl)
                  ? 'external'
                  : null,
              },
              item.linkText,
              (0, _isExternalUrl['default'])(baseUrl, item.linkUrl) &&
                (0, _core.jsx)(_External['default'], {
    ...
    bottomContent && (0, _core.jsx)('div', null, bottomContent)
  );
};
